...
var asmGlobalArg = {};
var asmLibraryArg = { "__lock": ___lock, "__unlock": ___unlock, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_resize_heap": _emscripten_resize_heap, "js_add": _js_add, "js_console_log_int": _js_console_log_int, "memory": wasmMemory, "table": wasmTable };
var asm = createWasm();
...
var real__print_the_answer = asm["print_the_answer"];
asm["print_the_answer"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
